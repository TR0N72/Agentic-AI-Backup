...
export default function Sidebar() {
    ...
    const getItemClass = (path: string) =>
        isActive(path)
            ? "bg-[#F4F4F5] rounded-[10px] p-3 mb-4 flex items-center w-full"
            : "flex items-center p-3 mb-4 w-full hovered:bg-gray-50 rounded-[10px]";

    const getIconColor = (path: string) => isActive(path) ? "#381FD1" : "#7F8183";
    const getTextColor = (path: string) => isActive(path) ? "text-[#381FD1]" : "text-[#7F8183]";

    return (
        <div className="w-[413px] bg-white shadow-lg flex-shrink-0 min-h-screen">
            <div className="p-8">
                {/* Logo */}
                <div className="flex items-center mb-8 mt-16">
                    <div className="h-11 w-11 rounded-full bg-[#381FD1] flex items-center justify-center">
                        <div className="h-6 w-6 rounded-full bg-white"></div>
                    </div>
                    <span className="ml-3 text-xl font-bold text-[#10284B] font-dm-sans">
                        Pinterin
                    </span>
                </div>
